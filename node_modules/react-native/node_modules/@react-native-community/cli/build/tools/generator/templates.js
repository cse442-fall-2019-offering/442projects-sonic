 ...
 */
async function createProjectFromTemplate(destPath, newProjectName, template, destinationRoot) {
  ...
  await createFromRemoteTemplate(template, destPath, newProjectName, destinationRoot);
}
/**
...
async function createFromRemoteTemplate(template, destPath, newProjectName, destinationRoot) {
  let installPackage;
  let templateName;
