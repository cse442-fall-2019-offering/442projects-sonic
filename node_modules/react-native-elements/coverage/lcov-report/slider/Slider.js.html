      ...
      &gt;
        ...
        &lt;Animated.View
          ...
          style={StyleSheet.flatten([
            ...
            mainStyles.thumb,
            orientation === 'vertical'
              ? mainStyles.thumbVertical(trackStyle &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >trackStyle.width)</span>
              : mainStyles.thumbHorizontal(trackStyle &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >trackStyle.height)</span>,
            thumbStyle,
            {
              transform: [
...
const styles = StyleSheet.create({
  ...
  thumbHorizontal: height =&gt; ({
    top: 22 + (height ? <span class="branch-0 cbranch-no" title="branch not covered" >(height - 4) / 2 </span>: 0),
  }),
  thumbVertical: width =&gt; ({
    left: 22 + (width ? <span class="branch-0 cbranch-no" title="branch not covered" >(width - 4) / 2 </span>: 0),
  }),
  touchArea: {
    position: 'absolute',
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Wed Sep 04 2019 22:13:57 GMT-0400 (Atlantic Standard Time)
</div>
</div>
