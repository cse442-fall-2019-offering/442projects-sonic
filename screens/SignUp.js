...
import { View, Text, StyleSheet,Picker, ScrollView, StatusBar, TextInput, Image, Alert } from 'react-native';
        ...
        return (
            <LinearGradient colors={['#61045f', '#20011f']} style={styles.LinearGradientView}>
                <ScrollView
                    ...
                    <TextInput style={styles.InputBox}
                        placeholder='Password'           // Need to make sure the users know the requirements 
                        placeholderTextColor='#ffffff'
                        underlineColorAndroid='transparent'
                    ...
                    <TextInput style={styles.InputBox}
                        placeholder='Re-enter password'  // Need to make sure the users know the requirements 
                        placeholderTextColor='#ffffff'
                        underlineColorAndroid='transparent'
                        secureTextEntry={true}
                        maxLength={20}
                    ...
                    <TextInput style={styles.InputBox}
                        placeholder='Age'                   // Need to make sure numbers are only added
                        placeholderTextColor='#ffffff'
                        underlineColorAndroid='transparent'
                    ...
                    <TextInput style={styles.InputBox}
                        placeholder='Phone Number'                // Need to make sure only numbers are added and that they add all the numbers
                        placeholderTextColor='#ffffff'
                        underlineColorAndroid='transparent'
                        keyboardType='numeric'
                        maxLength={10}
                    ...
                    <TextInput style={styles.InputBox}
                        placeholder='Height (in inches)'        // Need to make sure numbers are only added
                        keyboardType='numeric'
                        placeholderTextColor='#ffffff'
                        underlineColorAndroid='transparent'
                        maxLength={2}  
                    ...
                    <TextInput style={styles.InputBox}
                        placeholder='Current Weight'            // Need to make sure numbers are only added
                        placeholderTextColor='#ffffff'
                        underlineColorAndroid='transparent'
                        maxLength={3}
                        keyboardType='numeric'
                    ...
                    <TextInput style={styles.InputBox}
                        placeholder='Goal Weight'               // Need to make sure numbers are only added
                        placeholderTextColor='#ffffff'
                        underlineColorAndroid='transparent'
                        maxLength={3}
                        keyboardType='numeric'
